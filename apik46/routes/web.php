...
Route::post('/settings/genieacs', [SettingController::class, 'updateGenieACS'])->name('settings.genieacs.update');
Route::get('/settings/genieacs/test', [SettingController::class, 'testGenieACS'])->name('settings.genieacs.test');
});
...
Route::middleware('auth:pelanggan')->group(function () {
    ...
    Route::delete('/wifi-settings/{id}', [WifiSettingController::class, 'destroy'])->name('wifi-settings.destroy');
});
