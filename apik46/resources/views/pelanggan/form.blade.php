      ...
      <div class="col-12">
        <div class="card shadow mb-4">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="ip_address">IP PPPoE/Static</label>
              <input type="text" class="form-control" id="ip_address" name="ip_address" value="{{ isset($pelanggan) ? $pelanggan->ip_address : '' }}" placeholder="Contoh: 192.168.1.100 atau 10.0.0.1">
              <small class="form-text text-muted">Masukkan IP Address pelanggan (PPPoE atau Static)</small>
            </div>
            <div class="form-group">
